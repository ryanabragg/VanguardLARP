...
describe('<Bio />', () => {
  it('renders a div with the player name from props', () => {
    ...
    const wrapper = mount(<Bio player='test' editCharacter={editCharacter} editRace={editRace}/>);
  ...
  it('renders a div with the player build from props', () => {
    const editCharacter = spy(), editRace = spy();
    const wrapper = mount(<Bio name='test' playerBuild={42} editCharacter={editCharacter} editRace={editRace}/>);
  ...
  it('renders a div with the character build spent from props', () => {
    const editCharacter = spy(), editRace = spy();
    const wrapper = mount(<Bio name='test' spent={42} editCharacter={editCharacter} editRace={editRace}/>);
